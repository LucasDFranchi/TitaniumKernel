...
typedef enum kernel_error_s {
    ...
    /* -------- App/Sensors (0x900) -------- */
    KERNEL_ERROR_MUX_CHANNEL_ERROR    = 0x0900,
    KERNEL_ERROR_ADC_UPDATE_ERROR     = 0x0901,
    KERNEL_ERROR_ADC_CONFIGURE_ERROR  = 0x0902,
    KERNEL_ERROR_ADC_CONVERSION_ERROR = 0x0903,
