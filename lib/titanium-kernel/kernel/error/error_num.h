...
typedef enum kernel_error_s {
    ...
    /* -------- App/Sensors (0x800) -------- */
    KERNEL_ERROR_MUX_CHANNEL_ERROR    = 0x9000,
    KERNEL_ERROR_ADC_UPDATE_ERROR     = 0x9001,
    KERNEL_ERROR_ADC_CONFIGURE_ERROR  = 0x9002,
    KERNEL_ERROR_ADC_CONVERSION_ERROR = 0x9003,
