...
static const uint8_t CURRENT_HIGH_REGISTER_ADDRESS = 0x01;
static const uint8_t CURRENT_LOW_REGISTER_ADDRESS  = 0x02;
static const uint8_t POWER_HIGH_REGISTER_ADDRESS   = 0x03;
static const uint8_t POWER_LOW_REGISTER_ADDRESS    = 0x04;
